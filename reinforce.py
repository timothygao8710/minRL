...
@jax.jit
def loss(params, states, acts, adv):
...
if __name__ == '__main__':
    ...
    dloss_dparams = jax.grad(loss, argnums=0)
    ...
    for epoch in trange(1, config.epochs + 1):
        ...
        for sample in trange(1, config.rollouts_per_epoch + 1): 
        ...
        grad = dloss_dparams(params, S, A, adv)
